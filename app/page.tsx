export default function Home() {
  return (
    ...
    >
      <div
        className="bg-white shadow-lg p-5 rounded-3xl
        w-full max-w-screen-sm flex flex-col md:flex-row gap-2
      ...
      >
        ...
        <button
          ...
          active:scale-90 transition-transform font-medium
          md:px-10 bg-black"
        >
          Log in
        </button>
